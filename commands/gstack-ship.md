...
### B2-B8 — Bootstrap detail (research, framework selection, install, verify, CI/CD, TESTING.md, CLAUDE.md update, commit)

**See:** [`references/test-bootstrap-deep.md`](references/test-bootstrap-deep.md) (115 lines, lazy-loaded)

Read this reference ONLY when bootstrap actually needed (no existing test framework AND user accepts new framework). For repos with existing test infrastructure, skip — go to Step 5.
