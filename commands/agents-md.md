...
### Example 1: ASR Musil web project
```markdown
# AGENTS.md — ASR Musil Web (asr.oneflow.cz)

## Project Context
Subdoména pro klienta ASR Musil. Hostováno Contabo bratranec (185.190.143.1). Smlouva V3, 50k+42k retainer.
...
- OneFlow visual identity v ASR subdoméně
...
### Example 2: Beskyd Estate (md.oneflow.cz)
```markdown
# AGENTS.md — Beskyd Estate (md.oneflow.cz)

## Project Context
JV s MD. 3 datarooms, podpis pending. Source: `~/Desktop/OneFlow/OneFlowApp/md-site/` (Vercel projekt md-oneflow). NE `~/beskyd-estate-web/stitch-version/` (deprecated).

## Active Requirements
- **2026-05-06**: Source of truth = Vercel projekt `md-oneflow`, ne stitch verze
- **2026-05-06**: Email kontakt = `dopita@oneflow.cz` (ne lukas@)
- **2026-05-06**: Brand: oficiální OneFlow identity (ne Beskyd-only)

## External References
- Live: md.oneflow.cz
- Vercel: md-oneflow project
