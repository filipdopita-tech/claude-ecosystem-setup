...
| **Email intelligence pipeline — MIME → structured data, <email> mass processing, DMARC bulk reports, cold outreach reply intent classification, podcast guest threads** | agent: `agency-email-intelligence` (chain s gws-workflow-email-to-task, /findall, gateway-session) |
