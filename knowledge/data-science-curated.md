...
| <klient> pipeline scoring (1917 podnikatelů) | **scikit-learn ensemble (RF + LGBM)** | tabular features, interpretable |
...
- **[Polars](https://github.com/pola-rs/polars)** — Rust-backed Pandas alternativa, **3-30× faster** pro 10k+ rows. Použij pro <klient> dataset, scraping 10k+, batch DD.
