...
```bash
python3 $HOME/Documents/Claude_NotebookLM/notebooklm_skill.py pipeline \
...
7. "[Specifická otázka relevantní pro [YOUR_COMPANY]/[YOUR_NAME]]"
...
- Claude Code DOPLNÍ vlastní kontext (memory, rules, [YOUR_COMPANY] specifika)
