...
[YOUR_NAME] je na Personal level, Conductor/Paseo řeší Team use case ad hoc.
...
[YOUR_COMPANY] implementace tohoto loopu:
...
Framework je konceptuální — [YOUR_NAME] má vlastní implementaci každého kroku. PAI repo nemá skills/tools ke stažení, je to framework dokumentace + filozofie.
