...
| WhatsApp | Variable | Signal-based, short | 26.2% reply on 2026-04-22 <klient> campaign |
...
- **26.2% reply rate** on <klient> WhatsApp campaign — channel matters as much as copy
...
**WhatsApp format (<klient> campaign):** Short, specific, personal hook. Max 80 words. No pitch in opener — ask or observation only.
