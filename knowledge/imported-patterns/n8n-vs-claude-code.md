...
- Stack documentation: ~/.claude/projects/-Users-filipdopita/memory/project_conductor.md
- Cost discipline: ~/.claude/rules/cost-zero-tolerance.md (n8n self-hosted free, n8n.cloud paid)
- VPS routing: ~/.claude/projects/-Users-filipdopita/memory/infra_vps_routing_rules.md
