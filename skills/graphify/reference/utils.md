# graphify utils (update / cluster-only / add / watch / hooks / native)

Loaded by `--update`, `--cluster-only`, `/graphify add`, `--watch`, git hook, native CLAUDE.md integration.
...
## --watch + git hook + native CLAUDE.md
