...
**Volání:** Použij přímo (např. "spusť DD-MAX chain na <projekt>"), nebo necháš auto-trigger podle keyword v workflow-routing.md.
...
**Kdy:** Production-grade dokument pro klienta (<klient> proposal, retainer, custom DD output).
...
- `oneflow-<klient>-landing.md` — B2B SaaS hero landing
