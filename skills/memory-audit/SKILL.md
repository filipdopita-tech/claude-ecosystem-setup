---
name: memory-audit
description: "Audit staleness memory entries v ~/.claude/projects/<your-project-id>/memory/. Najde entries bez last_verified, starší 30/60 dní, bez frontmatteru. Nenavrhuje mazat automaticky — Filip rozhoduje. Aktivuj: /memory-audit nebo 'audit memory', 'stale memory', 'zkontroluj paměť'."
allowed-tools:
  - Bash
  - Read
  - Grep
