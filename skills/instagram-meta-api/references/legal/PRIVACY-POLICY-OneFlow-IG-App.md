...
This integration is operated by **OneFlow s.r.o.**, a Czech limited liability company headquartered in Prague, Czech Republic ("we", "us", "our"). For privacy questions contact: **dopita@oneflow.cz**.
...
To exercise any of these rights, contact **dopita@oneflow.cz**.

### 9. Meta data deletion

To request deletion of any data this App may have processed about you:

1. Email **dopita@oneflow.cz** with subject "Meta App Data Deletion — [your IG handle]".
...
We will update this Policy if Meta API scope changes or our processing practices change. The "Last updated" date at the top reflects the most recent revision. Material changes will be communicated via email to dopita@oneflow.cz subscribers if applicable.
